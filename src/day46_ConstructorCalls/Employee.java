...
public class Employee {
    ...
    public Employee(String name, String jobTitle){
        this(name);// sets the name / put this() on the first step,
                    // otherwise it will give compiler error
        this.jobTitle  = jobTitle;
    }
    public Employee (String name, String jobTitle,int ID){
            this(name,jobTitle); //sets name & jobTitle
            this.ID = ID;
    }
    public Employee (String name, String jobTitle,int ID,double salary){
        this(name,jobTitle,ID); //sets name & jobTitle & ID
        this.salary = salary;
    }
